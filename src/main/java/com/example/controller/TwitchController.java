...
public class TwitchController {
 ...
 // 유저 프로필이미지 가져오기
    ...
    // follow가져오기
    @GetMapping(value = "/follow/{streamerId}",
            produces = {MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE})
    public String getFollow(@PathVariable("streamerId") String streamerId) {
        System.out.println("follow 접근");
        ...
        try {
            ...
            String url = "https://api.twitch.tv/helix/users/follows?to_id="+streamerId;
